...
dirs = {
    'RoundRobin': r"C:\Users\dougl\OneDrive\Área de Trabalho\NGINX - ROUDROBIN\compilados",
    'LeastConn':   r"C:\Users\dougl\OneDrive\Área de Trabalho\NGINX - LEASTCON\compilados",
}

output_dir = r"C:\Users\dougl\OneDrive\Área de Trabalho\GRAFUCOS ANALISE NGINX"
...
for alg, folder in dirs.items():
    ...
    for filepath in glob.glob(pattern):
        ...
        alg_key, pub_str, msg_str, broker_str = fname.rsplit("_", 3)
